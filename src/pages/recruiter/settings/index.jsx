// Recruiter settings — currently one section (Integrations), built as a
// shell so branding and team management have somewhere to land later. Until
// this existed, org configuration lived only in the one-time onboarding
        ...
        <section className="min-h-[calc(100vh-76px)] rounded-[10px] border border-border-subtle bg-surface px-[39px] pb-[24px] pt-[42px]">
          <div className="min-w-0">
            ...
            <p className="mt-[5px] text-[15px] leading-[17px] text-text-secondary">
              Connect TruDev to the tools your team already uses.
            </p>
          </div>
          ...
          <div className="mt-[34px]">
            ...
            <p className="mt-1 max-w-[70ch] text-[13.5px] leading-[19px] text-text-secondary">
              Once connected, recruiters can add a TruDev assessment to an
              interview stage in your ATS. Candidates are invited automatically
              and scores appear on their profile.
            </p>
